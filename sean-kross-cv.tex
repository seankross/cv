...
\section{} \vspace{0.1in} \textbf{AWARDS AND HONORS} \vspace{-0.1in}

\section{05/2012} New York University President's Service Award
%\section{04/2018} CHI Honorable Mention Paper Award [C.38]
...
\item[P.2] Elissa M.\ Redmiles, Lisa Maszkiewicz, Emily Hwang, Dhruv Kuchhal, 
Everest Liu, Miraida Morales, Denis Peskov, Sudha Rao, Rock Stevens, Kristina 
Gligoric, \textbf{Sean Kross}, Michelle L.\ Mazurek, Hal Daumé III. Digital 
Words: Moving Forward with Measuring the Readability of Online Texts. 
In \emph{Technical Reports of the University of Maryland Computer Science 
...
\section{} \vspace{0.2in} \textbf{TALKS} \vspace{0.05in}
...
\section{} \vspace{0.2in} \textbf{TEACHING} \vspace{-0.05in}
